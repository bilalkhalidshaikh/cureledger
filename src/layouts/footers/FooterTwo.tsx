          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 mb-30">
              <div className="td-footer-3-widget">
                ...
                <Link className="links mb-40 d-inline-block" to="#">
                  Texas —<br /> 2025 Guadalupe St, Suite 260
                  <br /> Austin, TX 78705
                </Link>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 mb-30">
              <div className="td-footer-3-widget">
                ...
                <Link
                  className="links links-3 d-block mb-5"
                  to="mailto:contact@cureledger.com"
                >
                  contact@cureledger.com
                </Link>
                <Link className="links-2" to="tel:+17379002401">
                  (737) 900-2401
                </Link>
              </div>
            </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-4">
                <div className="td-footer-3-copyright text-lg-end mb-10">
                  <p>
                    © 2026 <Link to="#">CureLedger.</Link> All Rights Reserved.
                  </p>
                </div>
              </div>
            </div>
