                  ...
                  <div className="row">
                     ...
                     <div className="col-lg-3 col-md-6 mb-30">
                        <div className="td-footer-3-widget">
                           ...
                           <Link className="links links-3 d-block mb-5" to="#">hello@cureledger.com</Link>
                  ...
                  <div className="row">
                     <div className="col-lg-12">
                        <div className="text-center pt-20">
                           <h2 className="td-footer-3-middle-title"> studio</h2>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div className="row">
                     ...
                     <div className="col-lg-4">
                        <div className="td-footer-3-copyright mb-30">
                           <p>© 2025 <Link to="#">.</Link> All Rights Reserved.</p>
                        </div>
                     </div>
                  </div>
               </div>
