               ...
               <div className="container">
                  <div className="row align-items-center">
                     <div className="col-xl-2 col-4">
                        <div className="logo">
                           <Link className="logo-1" to="/"><img data-width="96" src="/assets/img/logo/cure-ledger.png" alt="Logo" /></Link>
                           <Link className="logo-2 d-none" to="/"><img data-width="96" src="/assets/img/logo/cure-ledger.png" alt="Logo" /></Link>
                        </div>
                     </div>
