...
const ContactForm = () => {
  ...
  const sendEmail = async (data: FormData) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/contact@cureledger.org",
        {
          method: "POST",
          headers: {
  ...
  //         </div>
  //         <h2 className="fw-bold mb-3" style={{ color: "#003941" }}>
  //           Message Sent!
  //         </h2>
  //         <p
  //           className="fs-5 mb-0"
  //           style={{ color: "#002C34", opacity: 0.8, lineHeight: "1.6" }}
  //         >
  //           Thank you for reaching out. <br /> One of our billing experts will
  //           contact you shortly.
  //         </p>
  //       </div>
  //     );
    ...
    return (
      <div ref={successRef} className="text-center py-5 px-3">
        ...
        <button
          ...
          className="btn btn-link mt-4 fw-bold"
    ...
    <form id="contact-form" ref={formRef} onSubmit={handleSubmit(sendEmail)}>
      ...
      <div className="row g-4">
        ...
        >
          ...
          />
          {errors.user_name && (
            <p className="text-danger small mt-1 fw-bold">
        ...
        >
          ...
          >
            {isSubmitting ? (
              <>
                SENDING...{" "}
                <i className="fa-solid fa-circle-notch fa-spin ms-1"></i>
              </>
            ) : (
              <>
