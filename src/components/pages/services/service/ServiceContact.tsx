  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/ajax/contact@cureledger.org", {
        ...
        body: JSON.stringify({
          _subject: "New Service Request from CureLedger Website!",
          ...data,
        }),
      });
    ...
    >
      ...
      <div className="container position-relative z-index-2">
        <div className="row align-items-center">
          ...
          {/* Right Column: Working AJAX Form / Success Modal */}
          <div className="col-lg-7">
            <div
            ...
            >
              {status === "success" ? (
                /* IN-PAGE SUCCESS DIALOG */
                <div className="h-100 d-flex flex-column align-items-center justify-content-center text-center py-5 fade-in">
                  <div
                  ...
                  <h3 className="fw-black mb-3" style={{ color: "#003941" }}>
                    Request Received!
                  </h3>
                  <p
                  ...
                  >
                    Thank you for reaching out to CureLedger. One of our RCM
                    experts will review your details and contact you shortly.
                  </p>
                  <button
                    onClick={() => setStatus("idle")}
                    className="btn btn-link mt-3 fw-bold"
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-md-6">
                      ...
                      >
                        ...
                        <option value="Comprehensive Scheduling">Comprehensive Scheduling</option>
                        <option value="Fill the Chair / Recalls">Fill the Chair / Recalls</option>
                        <option value="Digital Marketing">Digital Marketing</option>
                        <option value="Insurance Billing & A/R">Insurance Billing & A/R</option>
                    ...
                    <div className="col-12 mt-4 pt-2 text-end">
                      <button
                        ...
                        className="px-5 py-3 rounded-pill fw-bold border-0 shadow-sm d-inline-flex align-items-center gap-2"
                        style={{
                          backgroundColor: status === "submitting" ? "#A3B1B2" : "#09B2AB",
                          color: "#ffffff",
                          transition: "all 0.3s ease",
