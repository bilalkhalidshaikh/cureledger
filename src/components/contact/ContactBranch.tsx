...
const ContactBranch = () => {
   ...
   useEffect(() => {
      gsap.fromTo(cardRef.current, 
         { y: 50, opacity: 0 }, 
         { y: 0, opacity: 1, duration: 1, ease: "power3.out", scrollTrigger: { trigger: cardRef.current, start: "top 85%" } }
      );
   }, []);
   ...
   const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      gsap.to(cardRef.current, { rotationY: x, rotationX: -y, transformPerspective: 1000, ease: "power2.out", duration: 0.4 });
   };

   const handleMouseLeave = () => {
      if (window.innerWidth < 992 || !cardRef.current) return;
      gsap.to(cardRef.current, { rotationY: 0, rotationX: 0, ease: "power3.out", duration: 0.8 });
   };
         ...
         <div className="container">
            ...
            <div className="row justify-content-center mb-50">
               <div className="col-12 text-center wow fadeInUp" data-wow-duration="1s">
                  <span className="mb-3 d-inline-block px-4 py-2 rounded-pill shadow-sm" style={{ backgroundColor: '#ffffff', color: '#09B2AB', fontWeight: 'bold', fontSize: '13px', letterSpacing: '1px', border: '1px solid rgba(9,178,171,0.2)' }}>
                     OUR HEADQUARTERS
                  </span>
                  <h2 className="td-section-page-title" style={{ color: '#003941', fontWeight: 900 }}>Global Reach, <span style={{ color: '#09B2AB' }}>Local Service.</span></h2>
               </div>
            </div>
            ...
            <div className="row justify-content-center">
               <div className="col-lg-10">
                  <div 
                     ...
                     style={{ border: '1px solid rgba(0,57,65,0.05)', transition: 'box-shadow 0.3s ease' }}
                     onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 20px 40px rgba(9, 178, 171, 0.1)'}
                  >
                        ...
                        <div className="col-md-7 ps-md-4">
                           ...
                           <div className="d-flex flex-wrap gap-4 mt-4 pt-4 border-top">
                              ...
                              <div>
                                 ...
                                 <Link to="mailto:info@cureledger.org" className="fs-5 fw-bold" style={{ color: '#003941', textDecoration: 'none' }}>info@cureledger.org</Link>
                              </div>
                           </div>
                        </div>
