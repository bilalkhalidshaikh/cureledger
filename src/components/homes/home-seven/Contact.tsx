        ...
        <div className="td-contact-7-text-btn text-center pt-30">
          <Link to="/contact">
            <img
              ...
              src="/assets/img/contact/text.png"
              alt=""
            />
            <span className="icon">
              <svg
        ...
        >
          {contact_slider.map((item) => (
            <SwiperSlide key={item.id} className="swiper-slide">
              <h2 className={`td-contact-7-slide-text ${item.class}`}>
                {item.title}
              </h2>
            </SwiperSlide>
          ))}
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5 mb-40">
              <div
                className="td-contact-7-content wow fadeInLeft"
                data-wow-delay=".4s"
                data-wow-duration="1s"
              >
                <h2 className="td-section-7-title mb-70">
                  Let’s get in
                  <br /> touch 🤟
                </h2>
                <h6 className="td-contact-7-subtitle mb-35">
                ...
                <div className="td-contact-7-social">
                  <div className="td-contact-7-social-item mb-25 d-flex">
                    ...
                    <div>
                      ...
                      <Link className="link" to="tel:+18105851224">
                        +1 810 585 12 24
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="td-contact-7-social-item d-flex">
                    <span className="icon mr-20">
                      ...
                      >
                        <path
                          d="M15 7.81818C15 13.1212 8 17.6667 8 17.6667C8 17.6667 1 13.1212 1 7.81818C1 6.00989 1.7375 4.27566 3.05025 2.997C4.36301 1.71834 6.14348 1 8 1C9.85652 1 11.637 1.71834 12.9497 2.997C14.2625 4.27566 15 6.00989 15 7.81818Z"
                          stroke="#1F1306"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M7.99935 10.0909C9.28801 10.0909 10.3327 9.07333 10.3327 7.81814C10.3327 6.56294 9.28801 5.54541 7.99935 5.54541C6.71068 5.54541 5.66602 6.56294 5.66602 7.81814C5.66602 9.07333 6.71068 10.0909 7.99935 10.0909Z"
                          stroke="#1F1306"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
            ...
            <div className="col-lg-7 mb-40">
              <div
                className="td-contact-7-form ml-80 wow fadeInRight"
                data-wow-delay=".4s"
                data-wow-duration="1s"
              >
                <p className="mb-70">
                  ...
                  context, marketing can be defined as
                </p>
                <HomeContact />
              </div>
            </div>
