...
const Pricing = () => {
  ...
  return (
    <div
      className="td-pricing-area pt-120 pb-0"
      style={{ backgroundColor: "#F8FAFA", overflow: "hidden" }}
            ...
            >
              ...
              >
                ...
                <div className="td-pricing-6-top mb-35">
                  <span
                    className="package mb-15 d-inline-block fw-bold"
                    style={{
                      color: "#09B2AB",
                      fontSize: "1.1rem",
                  ...
                  <span
                    className="d-block mb-35 fw-bold"
                ...
                <div className="td-pricing-6-list">
                  <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                    {item.list.map((list, i) => (
                      ...
                      >
                        <i
                          className="fa-solid fa-check-circle mt-1 me-3"
                          style={{ color: "#09B2AB", fontSize: "14px" }}
                        ></i>
                        {list}
                      </li>
                    ))}
