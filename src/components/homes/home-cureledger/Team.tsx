      ...
      team_details: [
         {
            id: 1,
            class: "pb-130",
            thumb: "https://images.unsplash.com/photo-1664575602554-2087b04935a5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8d29tYW58ZW58MHwxfDB8fHww",
            designation: "Billing Director",
            name: (<>Sarah Adams</>),
            list: ["Claim Submissions ", "Ledger Audits ", "Denial Appeal"]
         },
         {
            id: 2,
            thumb: "https://images.unsplash.com/photo-1629425733761-caae3b5f2e50?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHByb2Zlc3Npb25hbCUyMG1hbnxlbnwwfDF8MHx8fDA%3D",
            designation: "Auditor ",
            name: (<>Mark Thomas</>),
            list: ["Claim Submissions ", "Ledger Audits ", "Denial Appeal"]
         },
      ...
      team_details: [
         {
            id: 1,
            class: "pb-130 pt-160",
            thumb: "https://plus.unsplash.com/premium_photo-1669324356026-ff4a63d177d0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8dGVjaCUyMHdvbWFufGVufDB8MXwwfHx8MA%3D%3D",
            designation: "Manager",
            name: (<>Emily Clark</>),
            list: ["Claim Submissions ", "Ledger Audits ", "Denial Appeal"]
         },
         {
            id: 2,
            thumb: "https://plus.unsplash.com/premium_photo-1669782051589-4f828261b1c2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fHByb2Zlc3Npb25hbCUyMG1hbnxlbnwwfDF8MHx8fDA%3D",
            ...
            <div className="row mb-20">
               ...
               <div className="col-lg-7 col-md-7">
                  <div className="td-service-2-title-wrap mb-40 td-title-anim">
                     <span className="td-section-2-subtitle mb-25 d-block">//  RCM team members</span>
                     <h2 className="td-section-2-title d-inline-block">CureLedger has top RCM billing <span>experts</span></h2>
                  </div>
               </div>
            </div>
            <div className="row">
                  ...
                  <div key={items.id} className="col-lg-6">
                     ...
                     {items.btn && <div className="td-team-2-btn">
                        <div className="td-btn-group mt-70  td-btn-group-black">
                           ...
                           <Link className="td-btn-2 td-btn-primary" to="/contact">Meet our experts</Link>
                           <Link className="td-btn-circle" to="/contact">
                              <i className="fa-solid fa-arrow-right"></i>
                           </Link>
                        </div>
