...
const Faq = () => {
   ...
   const handleMouseMove = (e: React.MouseEvent) => {
      ...
      if (imgRef.current) gsap.to(imgRef.current, { x: x * -1, y: y * -1, ease: "power2.out", duration: 1 });
      if (contentRef.current) gsap.to(contentRef.current, { x: x * 0.5, y: y * 0.5, ease: "power2.out", duration: 1 });
   };

   const handleMouseLeave = () => {
      gsap.to([imgRef.current, contentRef.current], { x: 0, y: 0, ease: "power3.out", duration: 1 });
   };
            ...
            <div className="row align-items-center">
               ...
               <div className="col-lg-6">
                  ...
                  >
                     ...
                     <div style={{ position: 'absolute', top: '-20px', left: '-20px', width: '100px', height: '100px', backgroundColor: 'rgba(9, 178, 171, 0.1)', borderRadius: '50%', zIndex: -1 }}></div>
                  </div>
               </div>

               {/* Right Column: Accordion Content */}
               <div className="col-lg-6">
                  <div ref={contentRef} className="td-faq-2-wrap-right ps-lg-5 mb-30 wow fadeInRight" data-wow-delay=".3s">
                     <div className="td-service-2-title-wrap mb-40">
                        <span className="d-inline-block mb-15 px-4 py-2 rounded-pill fw-bold" 
                              style={{ backgroundColor: 'rgba(9, 178, 171, 0.1)', color: '#09B2AB', fontSize: '14px', textTransform: 'uppercase' }}>
                           Common Questions
                        </span>
                        <h2 className="mb-0" style={{ color: '#003941', fontWeight: 800, fontSize: 'clamp(2rem, 4vw, 3rem)', lineHeight: '1.2' }}>
                           Everything you need to <br />
                           <span style={{ color: '#09B2AB' }}>know about our process.</span>
                        </h2>
                     </div>
                     ...
                     <div className="td-faq-accordion">
                        {faqData.map((item) => (
                           ...
                           >
                              <h2 className="m-0">
                                 ...
                                 >
                                    ...
                                    <span style={{ 
                                       color: '#09B2AB', 
                                       fontSize: '1.5rem', 
                                       transform: item.showAnswer ? 'rotate(45deg)' : 'rotate(0deg)',
                              ...
                              >
                                 <div className="p-4 pt-0" style={{ color: '#002C34', lineHeight: '1.6', opacity: 0.8 }}>
                                    {item.desc}
                                 </div>
                              </div>
                           </div>
