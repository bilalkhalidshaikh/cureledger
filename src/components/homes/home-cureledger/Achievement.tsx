...
const achievement_data: DataType[] = [
  {
    ...
    description: (
      <>
        Accurate eligibility checks and procedure-specific frequencies verified
        through a clinical lens. We catch potential 'downgrades' before you prep
        the tooth, ensuring patients and providers have 100% financial clarity
        upfront.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        We close the gap between the industry average of 92% and our{" "}
        <span style={{ color: "#09B2AB", fontWeight: 900, fontSize: "1.1rem" }}>
          98% collection rate
        </span>
        . Our team reviews your clinical notes and X-rays to ensure narratives
        are bulletproof, stopping denials for 'medical necessity' before they
        happen.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Relentless A/R follow-up powered by clinical authority. When insurance
        stalls, we provide the doctor-to-doctor appeals and evidence-based
        rebuttals required to secure payment for your most complex cases.
      </>
    ),
  },
];
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "600px",
          background:
            "radial-gradient(circle, rgba(9,178,171,0.08) 0%, rgba(0,57,65,0) 70%)",
          borderRadius: "50%",
          zIndex: 0,
          pointerEvents: "none",
          filter: "blur(60px)",
      ...
      <div className="container p-relative z-index-1">
        ...
        <div className="row justify-content-center mb-60">
          <div className="col-xl-9 col-lg-10 text-center achieve-anim">
            ...
            >
              Clinical Intelligence at Every{" "}
              <br className="d-none d-lg-block" /> Stage of Your{" "}
              <span style={{ color: "#09B2AB" }}>Revenue Cycle.</span>
            </h2>
            ...
            >
              ...
              clinical nuances shouldn't be your daily distraction. We optimize
              your entire revenue cycle—from chairside verification to final
              payment reconciliation—using doctor-to-doctor insight that generic
              billers simply don't have.
            </p>
          </div>
        </div>
        ...
        <div className="row justify-content-center g-4 mb-5">
          {achievement_data.map((item, index) => (
            <div
              key={item.id}
              className="col-lg-4 col-md-6 col-sm-12 achieve-anim"
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 30px 60px rgba(0, 0, 0, 0.6), inset 0 0 20px rgba(9, 178, 171, 0.15)";
                }}
              >
                ...
                >
                  ...
                  <p
                    className="mb-4 fw-bold text-uppercase small"
                  ...
                  <div
                    className="p-3 mb-4 rounded-3 shadow-sm"
                    style={{
                      backgroundColor: "rgba(9, 178, 171, 0.08)",
          ...
          <div className="col-lg-11">
            ...
            >
              ...
              <div className="d-flex flex-column flex-sm-row align-items-center text-center text-sm-start gap-4 z-index-1">
                ...
                <div>
                  <h4 className="m-0 text-white fw-bold mb-2">
                  ...
                  >
                    We operate directly within your existing practice management
                    software via secure, HIPAA-compliant remote access.
                  </p>
                </div>
              </div>
                ...
                {["Dentrix", "Eaglesoft", "Open Dental"].map((software, i) => (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 10px 20px rgba(9, 178, 171, 0.3)";
                    }}
                    onMouseLeave={(e) => {
